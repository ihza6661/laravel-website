  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-5 py-3">
        <form action="tambah_kontak.php" method="post">
          <div class="mb-3">
            <label for="nama" class="form-label">Nama Lengkap</label>
            <input type="text" name="nama_kontak" class="form-control" id="nama" aria-describedby="nama" placeholder="Nama Lengkap">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <textarea type="text" name="pesan" class="form-control" id="pesan" rows="3" aria-describedby="email"
